...
建設機器レンタル・修理会社では、以下のような課題を抱えていました。
...
- EV 充電器と、それと連携するサーバー側のシステムの構築および運用に携わっています(IoT)
- EV 充電用のモバイルアプリケーション開発や、そのバックエンド API の開発にも携わっています(Mobile)
